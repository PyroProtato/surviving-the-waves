...
var chest_ui = preload("res://scenes/chest_ui.tscn")
var chest_data = [[null, null], [null, null], [null, null], [null, null], [null, null], [null, null], [null, null]]
...
func delete():
	...
	for item in chest_data:
		if item != [null, null]:
			game_manager.add_item(item[0], item[1])
	queue_free()
